...
## Summary/Description
Shows the number of artifacts that were associated with the particular "bucket" field value for each day.  
...
![screenshot](./images/artifact-history-matrix.png "This is an example")

The number of historical days shown is configured via the app settings.  Setting the value to "5" will show numbers for the last 5 days.  

The "bucket" field is also configured via the app settings.  Bucket fields include any string fields that are not read only and the following exceptions:
